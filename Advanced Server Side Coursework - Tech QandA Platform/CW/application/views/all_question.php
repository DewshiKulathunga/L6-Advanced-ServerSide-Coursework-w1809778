            ...
            <ul>
                <?php foreach ($questions as $question): ?>
                    ...
                    <p><?php echo $question['content']; ?></p>
                        <p>Asked by: <?php echo isset($question['user_name']) ? $question['user_name'] : 'Unknown'; ?></p>
                        <p>Tags: <?php echo isset($question['tags']) && is_array($question['tags']) ? implode(', ', $question['tags']) : 'No tags'; ?></p>
                        <p>Created at: <?php echo $question['created_at']; ?></p>
                    </li>
                <?php endforeach; ?>
            </ul>
